...
public final class EdgeUtil {
    ...
    public static final double MIN_PROBE = 0.3D; // blocks

    private EdgeUtil() {
    }

    /** Mirrors vanilla's sneak edge probe in eight directions. */
    ...
    /** Fall risk along current motion, or the held key heading when starting from rest. */
    ...
    /** Probes along the normalized direction; a near-zero direction returns false. */
