...
public class Velocity extends Module {
    ...
    /** Set by {@link #onHurt}, cleared at the next {@link #onStrafe} (jump must be fed to movementInput). */
    ...
    public void onStrafe(EventStrafe event) {
        ...
        pendingHit = false;
        // knockback leaves motionY ~+0.4; fall damage fires EventHurt too, but onLanded zeroed motionY first
        ...
        if (random.nextDouble() * 100.0 < chance.get()) {
            // vanilla's gated jump (super.onLivingUpdate) consumes this later THIS tick
