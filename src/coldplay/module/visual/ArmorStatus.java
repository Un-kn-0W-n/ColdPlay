...
/** Empty armor slots remain visible while editing so the HUD stays draggable. */
public class ArmorStatus extends Module {
    ...
    public void onRender2D(EventRender2D event) {
        ...
        // Default: centered, sitting above the vanilla hotbar + status-bar rows (dragged from there).
        ...
        // Helmet..boots left to right (armorInventory is boots-first: index 3..0).
        int x = state.x;
