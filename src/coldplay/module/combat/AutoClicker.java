...
public class AutoClicker extends Module {
    ...
    public void onUpdate(EventUpdate event) {
        ...
        // No generated swings at fake players; vanilla still handles the physical press.
        if (kb == mc.gameSettings.keyBindAttack && BotTracker.getInstance().isBot(mc.pointedEntity)) {
            nextClickAt = 0L;
            return;
        }
        ...
        if (now >= nextClickAt) {
            // one generated click per tick, so 20 CPS is the ceiling
