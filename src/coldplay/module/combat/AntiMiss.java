...
public class AntiMiss extends Module {
    public AntiMiss() {
        super("AntiMiss", Category.COMBAT, "Prevents left-click swings when your crosshair hits nothing or a fake player.");
    }
    ...
    public void onAttack(EventAttack event) {
        ...
        if (target == null || target.typeOfHit == MovingObjectPosition.MovingObjectType.MISS
                ...
                && BotTracker.getInstance().isBot(target.entityHit))) {
