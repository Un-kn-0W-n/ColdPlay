...
/** SOCKS5 proxy settings. An empty username means no authentication. */
public final class ProxyConfig {
    ...
    /** Parses host:port or [ipv6]:port. Returns null for blank input; throws IllegalArgumentException on a malformed address. */
