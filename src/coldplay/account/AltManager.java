...
/** Saved accounts in coldplay/alts.json, deduplicated by UUID, newest first. Premium and cracked alts are capped separately. */
public final class AltManager {
    ...
    /** Unmodifiable snapshot, newest first. */
