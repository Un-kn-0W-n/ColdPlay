...
/**
 * Delays decoded S14/S18 movement semantics for BackTrack's current target. This is the client's
 * one intentional inbound packet-semantic exception; modules themselves never see packets.
 */
