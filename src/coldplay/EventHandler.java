...
/**
 * Dispatches events to {@link EventTarget} methods, highest priority first. Registration swaps
 * immutable subscription arrays so dispatch needs no lock.
 */
public class EventHandler {
    ...
    /** Dispatches to handlers of the exact runtime type only, highest priority first. */
