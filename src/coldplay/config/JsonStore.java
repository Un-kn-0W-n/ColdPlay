...
/**
 * Reusable, failure-safe JSON file lifecycle: defaults, UTF-8 parsing, corrupt-file backup,
 * temporary writes and atomic replacement when the filesystem supports it.
 */
public final class JsonStore<T> {
    ...
    /**
     * Report to chat once per store so disk failures do not spam every module toggle.
     * Logging remains available before the in-game GUI exists.
     */
