...
/** One codec for both the full client config and module-only named profiles. */
public final class ConfigCodec {
    ...
    /** @return false when there is no usable "modules" section: a missing, empty or corrupt file. */
    ...
    /** The scaled screen size the panel and HUD anchors below were captured in. Without it, a config
     *  written at a different GUI Scale would be re-anchored from the wrong reference on load. */
