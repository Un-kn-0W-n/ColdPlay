...
public class PlayerControllerMP
{
    ...
    {
        // ColdPlay >>> EventDig, then sync the slot so a listener's C09 precedes this dig's C07s
    ...
    {
        // ColdPlay >>> DigGuard (Breaker releases it before its own reset)
    ...
    {
        // ColdPlay >>> EventDig, before the slot sync below
        ...
        {
            // ColdPlay: clickBlockBody, since EventDig was already posted above
    ...
    // ColdPlay >>> unquantized break progress for Breaker
