...
public class Minecraft implements IThreadListener, IPlayerUsage {
     ...
     * another block.
     */
    public int rightClickDelayTimer; // ColdPlay: made public
    ...
    private void drawSplashScreen() {
        ...
        GlStateManager.enableTexture2D();
        // ColdPlay: shader backdrop and wordmark instead of the Mojang logo
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                // ColdPlay >>> EventMouse (i == -1 is a move/wheel-only event)
    ...
    /** ColdPlay: swaps the active account session. */
