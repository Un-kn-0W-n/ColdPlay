...
public class GuiTextField extends Gui
{
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_)
    {
        ...
        if (this.isFocused && flag && p_146192_3_ == 0)
        {
            ...
            String renderedText = this.getRenderedText();
            String s = this.fontRendererInstance.trimStringToWidth(renderedText.substring(this.lineScrollOffset), this.getWidth());
    ...
    public void setSelectionPos(int p_146199_1_)
    {
        ...
        if (this.fontRendererInstance != null)
        {
            ...
            int j = this.getWidth();
            String renderedText = this.getRenderedText();
            String s = this.fontRendererInstance.trimStringToWidth(renderedText.substring(this.lineScrollOffset), j);
            int k = s.length() + this.lineScrollOffset;

            if (p_146199_1_ == this.lineScrollOffset)
            {
                this.lineScrollOffset -= this.fontRendererInstance.trimStringToWidth(renderedText, j, true).length();
            }
