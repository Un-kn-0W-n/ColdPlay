...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public int xSize = 176; // ColdPlay: public — read by EntityESP arrows GUI-avoidance

    /** The Y size of the inventory window in pixels. */
    public int ySize = 166; // ColdPlay: public — read by EntityESP arrows GUI-avoidance
     ...
     */
    public int guiLeft; // ColdPlay: public — read by EntityESP arrows GUI-avoidance

    /**
     * Starting Y position for the Gui. Inconsistent use for Gui backgrounds.
     */
    public int guiTop; // ColdPlay: public — read by EntityESP arrows GUI-avoidance
    ...
    /**
     * Whether a text field in this container is currently capturing keyboard input. When true, the
     * inventory keybind is treated as text entry instead of closing the screen (Escape still closes).
     */
    ...
    {
        if (keyCode == 1 || (keyCode == this.mc.gameSettings.keyBindInventory.getKeyCode() && !this.isTextFieldFocused()))
        {
