...
public class EffectRenderer
{
    ...
    {
        renderLitParticles(entityIn, partialTick, entityIn.rotationYaw, entityIn.rotationPitch);
    }

    public void renderLitParticles(Entity entityIn, float partialTick, float yaw, float pitch)
    {
        float f = 0.017453292F;
        float f1 = MathHelper.cos(yaw * 0.017453292F);
        float f2 = MathHelper.sin(yaw * 0.017453292F);
        float f3 = -f2 * MathHelper.sin(pitch * 0.017453292F);
        float f4 = f1 * MathHelper.sin(pitch * 0.017453292F);
