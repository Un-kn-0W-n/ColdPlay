...
public class ActiveRenderInfo
{
    ...
    public static final class State {
        private final Vec3 savedPosition = position;
        private final float x = rotationX, xz = rotationXZ, z = rotationZ, yz = rotationYZ, xy = rotationXY;
    ...
    {
        updateRenderInfo(entityplayerIn.rotationPitch, entityplayerIn.rotationYaw, p_74583_1_);
    }

    public static void updateRenderInfo(float pitch, float yaw, boolean reverse)
    {
