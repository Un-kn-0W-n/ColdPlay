...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    // ColdPlay >>> doneLoadingTerrain getter
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        // ColdPlay >>> GameStateTracker transition
    ...
    public void handleEntityTeleport(S18PacketEntityTeleport packetIn) {
        ...
        if (entity != null) {
            ...
            // ColdPlay >>> PositionGuard (BackTrack) may hold this update
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        ...
        // ColdPlay >>> SwordBlock packet hold
    ...
    public void handleOpenWindow(S2DPacketOpenWindow packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        // ColdPlay >>> EventOpenWindow
        coldplay.event.EventOpenWindow cpOpen = new coldplay.event.EventOpenWindow(packetIn);
        coldplay.ColdPlay.post(cpOpen);
        if (cpOpen.isCancelled()) return;
