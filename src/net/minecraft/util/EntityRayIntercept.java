...
/**
 * Shared, side-effect-free entity interception along a ray segment.
 *
 * <p>The box expansion, start-inside handling and nearest-hit bookkeeping are centralized here.
 * Callers supply only candidate eligibility and the small selection policy that differs between
 * vanilla mouse picking and projectile collision.</p>
 */
