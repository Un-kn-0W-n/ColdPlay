...
public class Vec3
{
    ...
    /** Returns the geometric center of a unit block at {@code pos}. */
    public static Vec3 atBlockCenter(BlockPos pos)
    {
        return new Vec3((double)pos.getX() + 0.5D,
                (double)pos.getY() + 0.5D,
                (double)pos.getZ() + 0.5D);
    }

    /** Returns the center point of {@code face} on the unit block at {@code pos}. */
    public static Vec3 atFaceCenter(BlockPos pos, EnumFacing face)
    {
        return atBlockCenter(pos).addVector(
                (double)face.getFrontOffsetX() * 0.5D,
                (double)face.getFrontOffsetY() * 0.5D,
                (double)face.getFrontOffsetZ() * 0.5D);
    }

    /** @deprecated Use {@link #atBlockCenter(BlockPos)}. */
    @Deprecated
    public static Vec3 atCenter(BlockPos pos)
    {
        return atBlockCenter(pos);
    }
