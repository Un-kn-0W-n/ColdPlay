...
public class EnchantmentHelper {
	...
	/** Vanilla Efficiency dig-speed contribution for the supplied stack ({@code level^2 + 1}). */
	public static float getEfficiencyDigBonus(final ItemStack stack) {
		final int level = getEnchantmentLevel(Enchantment.efficiency.effectId, stack);
		return level > 0 ? (float)(level * level + 1) : 0.0F;
	}
