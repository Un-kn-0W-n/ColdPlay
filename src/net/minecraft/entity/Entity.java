    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (flag)
            {
                ...
                for (d6 = 0.05D; x != 0.0D && !this.worldObj.hasSupportAtOffset(this, x, 0.0D); d3 = x)
                {
                    if (x < d6 && x >= -d6)
                    {
                        x = 0.0D;
                ...
                for (; z != 0.0D && !this.worldObj.hasSupportAtOffset(this, 0.0D, z); d5 = z)
                {
                    if (z < d6 && z >= -d6)
                    {
                        z = 0.0D;
                ...
                for (; x != 0.0D && z != 0.0D && !this.worldObj.hasSupportAtOffset(this, x, z); d5 = z)
                {
                    if (x < d6 && x >= -d6)
                    {
                        x = 0.0D;
