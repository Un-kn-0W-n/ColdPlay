...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public EntityArrow(World worldIn, EntityLivingBase shooter, float velocity)
    {
        ...
        Vec3 spawn = ProjectilePhysics.spawnPosition(shooter, 1.0F);
        this.setPosition(spawn.xCoord, spawn.yCoord, spawn.zCoord);
        Vec3 direction = ProjectilePhysics.lookDirection(this.rotationYaw, this.rotationPitch);
        this.setThrowableHeading(direction.xCoord, direction.yCoord, direction.zCoord, velocity * (float)ProjectilePhysics.ARROW_CONSTRUCTOR_SPEED_SCALE, 1.0F);
    }
    ...
    {
        Vec3 heading = ProjectilePhysics.heading(new Vec3(x, y, z), velocity, inaccuracy, this.rand, true);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            ProjectilePhysics.StepResult physicsStep = ProjectilePhysics.step(
                    ...
                    ProjectilePhysics.ARROW_PROFILE,
                    this,
                    new Predicate<Entity>()
                    {
                        public boolean apply(Entity candidate)
                        {
                            return candidate.canBeCollidedWith()
                                    && (candidate != EntityArrow.this.shootingEntity || EntityArrow.this.ticksInAir >= 5);
                        }
                    },
                    true,
                    inWater);
            ...
            ProjectilePhysics.StepState integrated = ProjectilePhysics.integrate(
                    ProjectilePhysics.StepState.from(this), ProjectilePhysics.ARROW_PROFILE, inWater);
