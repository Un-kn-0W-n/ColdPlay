...
/** Pure projectile math (charge, spawn offset, spread, interception, per-tick integration) shared by the entities and by prediction. */
public final class ProjectilePhysics
{
    ...
    /** Initial direction of an {@link EntityThrowable}; the pitch offset only affects the vertical component. */
    ...
    /** Normalizes a heading, applies Gaussian spread and scales it to launch velocity. Arrows use an extra random sign per component. */
    ...
    /** Drag on all axes, then gravity on Y, in vanilla's update order. */
    ...
    /** One projectile tick without touching the world: block clip, entity hit, drag and gravity. */
    ...
    /** Vanilla's projectile water test, without the flow-motion side effect. */
