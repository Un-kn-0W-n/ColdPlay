...
public abstract class EntityLivingBase extends Entity {
   ...
   public void performHurtAnimation() {
	  this.hurtTime = this.maxHurtTime = 10;
	  this.attackedAtYaw = 0.0F;
	  // ColdPlay >>> "we just took a hit" funnel (S0B hurt-animation path, local player only)
	  if (this == net.minecraft.client.Minecraft.getMinecraft().thePlayer)
   ...
   public void handleStatusUpdate(byte id) {
	  if (id == 2) {
		 ...
		 this.hurtTime = this.maxHurtTime = 10;
		 this.attackedAtYaw = 0.0F;
		 // ColdPlay >>> "we just took a hit" funnel (S19 entity-status path, local player only)
		 if (this == net.minecraft.client.Minecraft.getMinecraft().thePlayer)
			coldplay.ColdPlay.post(new coldplay.event.EventHurt());
		 // ColdPlay <<<
