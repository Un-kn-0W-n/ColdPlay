...
public class ConnectedParser {
	...
	public static Comparable parseValue(String str, Class cls) {
		// Plain if-chain: a nested ternary here unboxes a null Long for enum properties and throws NPE.
		if (cls == String.class) return str;
		if (cls == Boolean.class) return Boolean.valueOf(str);
		if (cls == Float.class) return Float.valueOf(str);
		if (cls == Double.class) return Double.valueOf(str);
		if (cls == Integer.class) return Integer.valueOf(str);
		if (cls == Long.class) return Long.valueOf(str);
		return null;
	}
